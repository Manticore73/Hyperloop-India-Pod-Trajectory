...
syms t1 s1 vt1 vs1
t1 = vpa(int((M_pod./((M_pod.*a_pusher)-(4.*F_lev1)-F_aero-F_lsd)),v,0,3.52),10);
s1 = vpa(int(((M_pod.*v)./((M_pod.*a_pusher)-(4.*F_lev1)-F_aero-F_lsd)),v,0,3.52),10);
disp('Phase 1 Time');
disp(t1);
...
syms t3 s3 
t3 = vpa(int((M_pod./((M_pod.*a_pusher)-(4.*F_lev2)-F_aero)),v,20,60),5);
s3 = vpa(int(((M_pod.*v)./((M_pod.*a_pusher)-(4.*F_lev2)-F_aero)),v,20,60),5);
disp('Phase 3 Time');
disp(t1+t2+t3);
...
syms t5 s5  
t5 = vpa(int(((M_pod)./(-(4.*F_lev2)-F_aero)),v,60,40),5);
s5 = vpa(int(((M_pod.*v)./(-(4.*F_lev2)-F_aero)),v,60,40),5); %for pusher acceleration of 0.5g% 
disp('Phase 5 Time');
disp(t1+t2+t3+t5);
...
% 55<v<10 %
syms t7 s7  
t7 = vpa(int(((M_pod)./(-F_brk1-(4.*F_lev2)-F_aero)),v,40,10),5);
s7 = vpa(int(((M_pod.*v)./(-F_brk1-(4.*F_lev2)-F_aero)),v,40,10),5); %for pusher acceleration of 0.5g% 
...
s8 = vpa(int(((M_pod.*v)./(-F_brk2-(4.*F_lev2)-F_aero-F_lsd)),v,10,3.52),5); %for pusher acceleration of 0.5g% 
disp('Phase 8 Time');
...
s9 = vpa(int(((M_pod.*v)./(-F_brk2-(4.*F_lev1)-F_aero-F_lsd)),v,3.52,0.1),5); %for pusher acceleration of 0.5g% 
disp('Phase 9 Time');
disp(t1+t2+t3+t5+t7+t8+t9);
disp('Phase 9 Distance');
disp(s1+s2+s3+s5+s7+s8+t9);
%plot(TimeN_half_g,DistanceN_half_g)
%plot(TimeN_half_g,VelocityN_half_g)