...
%%%%%%%%%%%%%%%%%%%%%%%Braking Equations%%%%%%%%%%%%%%%%%%%%%%%%%
syms F_brk1 F_brk2
F_brk1 = (-0.000699*v^3)+(0.2405*v^2)-(30.39*v)+2630;
F_brk2 = (1.357*v^3)-(57.74*v^2)+(614.6*v)-11.95;
...
%Constant Drag Phase%
syms t4 s4  
t4 = vpa(int(((M_pod)./((M_pod.*a_pusher)-(4.*F_lev3)-F_aero)),v,59.35,71.8),5);
s4 = vpa(int(((M_pod.*v)./((M_pod.*a_pusher)-(4.*F_lev3)-F_aero)),v,59.35,71.8),5); %for pusher acceleration of 0.7g% 
disp('Phase 4 Time');
disp(t1+t2+t3+t4);
...
syms t5 s5  
t5 = vpa(int(((M_pod)./(-(4.*F_lev3)-F_aero)),v,71.8,63.3),5);
s5 = vpa(int(((M_pod.*v)./(-(4.*F_lev3)-F_aero)),v,71.8,63.3),5); %for pusher acceleration of 0.7g% 
disp('Phase 5 Time');
disp(t1+t2+t3+t4+t5);
...
syms t6 s6  
t6 = vpa(int(((M_pod)./(-F_brk1-(4.*F_lev3)-F_aero)),v,63.3,59.35),5);
s6 = vpa(int(((M_pod.*v)./(-F_brk1-(4.*F_lev3)-F_aero)),v,63.3,59.35),5); %for pusher acceleration of 0.7g% 
disp('Phase 6 Time');
...
s7 = vpa(int(((M_pod.*v)./(-F_brk1-(4.*F_lev2)-F_aero)),v,59.35,10),5); %for pusher acceleration of 0.7g% 
disp('Phase 7 Time');
...
s8 = vpa(int(((M_pod.*v)./(-F_brk2-(4.*F_lev2)-F_aero-F_lsd)),v,10,3.52),5); %for pusher acceleration of 0.7g% 
disp('Phase 8 Time');
...
s9 = vpa(int(((M_pod.*v)./(-F_brk2-(4.*F_lev1)-F_aero-F_lsd)),v,3.52,0.1),5); %for pusher acceleration of 0.7g% 
disp('Phase 9 Time');
