...
%%%%%%%%%%%%%%%%%%%%%%%Braking Equations%%%%%%%%%%%%%%%%%%%%%%%%%
syms F_brk
F_brk = (-7.314*exp(-5.691))+(-2798*exp(-0.197));
%%%%%%%%%%%%%%%%%%%%%%%%%%% Acceleration Phase %%%%%%%%%%%%%%%%%%%%%%%%%%
...
syms t5 s5  
t5 = vpa(int(((M_pod)./(-(4.*F_lev3)-F_aero)),v,90.5,83),5);
s5 = vpa(int(((M_pod.*v)./(-(4.*F_lev3)-F_aero)),v,90.5,83),5); %for pusher acceleration of 1g% 
disp('Phase 5 Time');
disp(t1+t2+t3+t4+t5);
...
syms t6 s6  
t6 = vpa(int(((M_pod)./((2*F_brk)-(4.*F_lev3)-F_aero)),v,83,59.35),5);
s6 = vpa(int(((M_pod.*v)./((2*F_brk)-(4.*F_lev3)-F_aero)),v,83,59.35),5); %for pusher acceleration of 1g% 
disp('Phase 6 Time');
