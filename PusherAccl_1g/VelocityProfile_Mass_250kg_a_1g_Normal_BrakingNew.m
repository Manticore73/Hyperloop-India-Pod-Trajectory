...
%%%%%%%%%%%%%%%%%%%%%%%Braking Equations%%%%%%%%%%%%%%%%%%%%%%%%%
syms F_brk
F_brk = (-2.93*exp(-5.736))+(-1147*exp(-0.2028));
%%%%%%%%%%%%%%%%%%%%%%%%%%% Acceleration Phase %%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Constant Drag Phase%
syms t4 s4  
t4 = vpa(int(((M_pod)./((M_pod.*a_pusher)-(4.*F_lev3)-F_aero)),v,59.35,90.5),5);
s4 = vpa(int(((M_pod.*v)./((M_pod.*a_pusher)-(4.*F_lev3)-F_aero)),v,59.35,90.5),5); %for pusher acceleration of 1g% 
disp('Phase 4 Time');
disp(t1+t2+t3+t4);
...
syms t5 s5  
t5 = vpa(int(((M_pod)./(-(4.*F_lev3)-F_aero)),v,90.5,79),5);
s5 = vpa(int(((M_pod.*v)./(-(4.*F_lev3)-F_aero)),v,90.5,79),5); %for pusher acceleration of 1g% 
disp('Phase 5 Time');
disp(t1+t2+t3+t4+t5);
...
syms t6 s6  
t6 = vpa(int(((M_pod)./((2*F_brk)-(4.*F_lev3)-F_aero)),v,79,59.35),5);
s6 = vpa(int(((M_pod.*v)./((2*F_brk)-(4.*F_lev3)-F_aero)),v,79,59.35),5); %for pusher acceleration of 1g% 
disp('Phase 6 Time');
...
% 59.35<v<10 %
syms t7 s7  
t7 = vpa(int(((M_pod)./((2*F_brk)-(4.*F_lev2)-F_aero)),v,59.35,10),5);
s7 = vpa(int(((M_pod.*v)./((2*F_brk)-(4.*F_lev2)-F_aero)),v,59.35,10),5); %for pusher acceleration of 1g% 
disp('Phase 7 Time');
...
% 3.52<v<10 %
syms t8 s8  
t8 = vpa(int(((M_pod)./((2*F_brk)-(4.*F_lev2)-F_aero-F_lsd)),v,10,3.52),5);
s8 = vpa(int(((M_pod.*v)./((2*F_brk)-(4.*F_lev2)-F_aero-F_lsd)),v,10,3.52),5); %for pusher acceleration of 1g% 
disp('Phase 8 Time');
...
% 3.52<v<0 %
syms t9 s9  
t9 = vpa(int(((M_pod)./((2*F_brk)-(4.*F_lev1)-F_aero-F_lsd)),v,3.52,0.1),5);
s9 = vpa(int(((M_pod.*v)./((2*F_brk)-(4.*F_lev1)-F_aero-F_lsd)),v,3.52,0.1),5); %for pusher acceleration of 1g% 
disp('Phase 9 Time');
disp(t1+t2+t3+t4+t5+t6+t7+t8+t9);
disp('Phase 9 Distance');
disp(s1+s2+s3+s4+s5+s6+s7+s8+t9);
%plot(TimeN1g,DistanceN1g)
%plot(TimeN1g,VelocityN1g)
