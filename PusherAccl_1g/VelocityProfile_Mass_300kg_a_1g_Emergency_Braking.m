...
syms t5 s5  
t5 = vpa(int(((M_pod)./(-(4.*F_lev3)-F_aero)),v,90.5,83.25),5);
s5 = vpa(int(((M_pod.*v)./(-(4.*F_lev3)-F_aero)),v,90.5,83.25),5); %for pusher acceleration of 1g% 
disp('Phase 5 Time');
disp(t1+t2+t3+t4+t5);
...
syms t6 s6  
t6 = vpa(int(((M_pod)./(-F_brk1-(4.*F_lev3)-F_aero)),v,83.25,59.35),5);
s6 = vpa(int(((M_pod.*v)./(-F_brk1-(4.*F_lev3)-F_aero)),v,83.25,59.35),5); %for pusher acceleration of 1g% 
disp('Phase 6 Time');
